...
int check_version_and_redirect() {
    ...
    if (strcmp(LOCAL_VERSION, remote_version) != 0) {
        ...
        printf("\033[1;33mDownload the new version from the repository and open it:\n\n\033[0m");
        printf("\033[1;34mRedirecting to the repository for requesting to download new version and check what's new...\n\n\033[0m");
#ifdef _WIN32
...
#endif
        printf("\033[1;33mAfter Download latest version from the repository and open the program\n\n\033[0m");
        getch();
        return 1;
    } else {
        printf("\n\033[1;34m Version is up to date:\033[0m %s\n\n", LOCAL_VERSION);
        return 0;
    }
}
...
int main() {
    ...
    while(loop!=0) {
        ...
        printf("\n\n\033[1;34m ******************Version 1.0 Copyright (c) 2024**********************\033[0m\n\n\n");
        ...
        switch (option) {
            case 1:{
                ...
                printf("This is a simple College management system developed by MRS4NJ4Y.\n\n");
            ...
            break;
            case 2: {
                printf("\033[1;31m*First Go and login on CSVTU Digivarsity website using correct username and password Otherwise you cannot use it.\033[0m\n\n");
                printf("\033[1;33mAre you logged in to CSVTU website in the default browser?(y/n);\033[0m");
                scanf(" %c", &choice);
                if (choice == 'y' || choice == 'Y') {
                    printf("\033[1;35mNow you use, but if it is not working then check your login status.\033[0m\n");
                } else {
                    printf("\033[1;31mYou need to be logged in to CSVTU website in the default browser to use this feature.\n\033[0m");
                    printf("\033[1;31mPlease login to CSVTU website and then try again.\n\033[0m");
                    snprintf(command, sizeof(command), "start \"\" \"https://csvtu.digivarsity.online/WebApp/Result/SemesterResult.aspx?\"");
                    system(command);
                }
                printf("\033[0;34m****************Admit Card******************\n\n\033[0m");
                printf("\033[1;33m Enter year of AdmitCard/Result in Format(YYYY): \033[0m");
                scanf("%d", &year);
                printf("%s",green_bold);
            ...
            case 3:{
                ...
                scanf(" %c", &choice);
                if (choice == 'y' || choice == 'Y') {
                    printf("\033[1;35mNow you use, but if it is not working then check your login status.\n\033[0m");
                } else {
                    printf("\033[1;31mYou need to be logged in to CSVTU website in the default browser to use this feature.\n\033[0m");
                    printf("\033[1;31mPlease login to CSVTU website and then try again.\n\033[0m");
                    snprintf(command, sizeof(command), "start \"\" \"https://csvtu.digivarsity.online/WebApp/Result/SemesterResult.aspx?\"");
                ...
                if (resulttype == 1) {
                    ...
                    printf("\033[1;33mEnter custom result type: \033[0m");
            ...
            case 4:{
                ...
                printf("4. Restart the program and check the login status.\n");
                printf("5.If you are good and not seeing the result/admit card then it may be that they are not declared, please wait and try again later.\n\n");
            ...
            case 5:{
                ...
                printf("you can also see the result/Admit Card of previous and next semester.\n");
