...
#endif
        printf("\033[1;33mOpen the downloaded program after downloading the latest version from the repository.\n\n\033[0m");
        getch();
        return 1;
    } else {
...
int main() {
    ...
    printf("\n\033[1;33mAre you connected to the enternet(y/n):\033[0");
    scanf("%c", &connection);
    if (connection == 'y'|| connection =='Y') {
        printf("\n\033[1;35mVerifying your Internet connection...\n\033[0");
    }else{
        printf("\n\033[1;35mConnect to the Internet and try again.\n\033[0");
        getch();
    }
